    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 font-poppins p-6">
      <Card className="p-8 max-w-md w-full bg-white shadow-md rounded-xl border border-[#6793AC]/20 animate-zoom-in">
        <CardHeader className="p-0 flex flex-col items-center">
          <CheckCircle2 className="w-8 h-8 text-[#E4580B] mb-3 animate-bounce" />
        ...
        <div className="mt-6">
          <Button
            ...
            className="w-full bg-[#E4580B] hover:bg-[#E4580B]/90 text-white font-medium py-2 rounded-lg transition-all duration-300 transform hover:scale-105"
          >
            View Orders
          </Button>
        </div>
