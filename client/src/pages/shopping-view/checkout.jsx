  ...
  function handleInitiatePaypalPayment() {
    if (cartItems.length === 0) {
      toast({
        ...
        variant: "destructive",
        className: "bg-[#E4580B] text-white border-none font-poppins",
      });
      return;
    }
        ...
        <div className="flex flex-col gap-5 bg-white p-5 rounded-xl shadow-md border border-[#6793AC]/20 animate-slide-in-right">
          ...
          <div className="mt-6 space-y-3">
            <div className="flex justify-between items-center">
              ...
              <span className="font-bold text-base text-[#E4580B]">${totalCartAmount}</span>
            </div>
          </div>
          <div className="mt-5 w-full">
            <Button
              onClick={handleInitiatePaypalPayment}
              className={`w-full bg-[#E4580B] hover:bg-[#E4580B]/90 text-white font-medium py-2 rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2 ${
